...
export default function MessageOthers({dat}){
    ...
    return(
        <div style={{display:"flex"}}>
            ...
            <p style={{marginBottom:"10px",fontWeight:"400"}} className='msg-p'>{(dat.content.slice(0,4)==='img:')?<img src={`https://res.cloudinary.com/dbtis6lsu/image/upload/v1705092727/${dat.content.slice(4)}`}/>:dat.content}</p>
