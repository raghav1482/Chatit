...
export default function MessageSelf({dat}){
    ...
    return(
        <div className={'msg sent'+(light?"":" dark")}>
            <p style={{ margin: "10px 0 0 0" }} className="msg-p"
   dangerouslySetInnerHTML={{
     __html: (dat.content.slice(0, 4) === 'img:') 
       ? `<img src="https://res.cloudinary.com/dbtis6lsu/image/upload/v1705092727/${dat.content.slice(4)}" alt="user content"/>` 
       : dat.content
   }}>
</p>
